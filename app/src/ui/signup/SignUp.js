            ...
            <Row>
              ...
              <Col md={6} className="mb-3">
                <Card className="bg-dark-50 border text-light h-100">
                  ...
                  <Card.Body>
                    <p>This app has been created for public educational purposes. <span className="font-weight-bold">Profile usernames, email addresses, and posts created here are publicly accessible via our API REST endpoints</span>, so please keep this in mind before you sign up.</p>
